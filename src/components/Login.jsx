...
const Login = () => {
  return (
    <div className="w-full h-screen flex flex-col justify-center items-center bg-[#164095]">
      ...
      <div className="mt-[60px] w-[630px] h-[690px] bg-white flex flex-col rounded-[24px] ">
        ...
        <div className="pl-[56px]">
          ...
          <Input
            ...
            className="w-[516px] h-[56px] mb-2 font-medium rounded-lg pl-5 bg-[#F1F4F9] text-[#A6A6A6] border border-[#A6A6A6]"
          />
          <Checkbox label="Salvar Senha" name="Salvar" id="Salvar" />

          <div className="flex-col mt-[55px] ml-[105px]">
